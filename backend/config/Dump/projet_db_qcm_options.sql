...
CREATE TABLE `qcm_options` (
  ...
  CONSTRAINT `qcm_options_ibfk_1` FOREIGN KEY (`Id_question`) REFERENCES `questions` (`Id_question`)
...
LOCK TABLES `qcm_options` WRITE;
/*!40000 ALTER TABLE `qcm_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `qcm_options` ENABLE KEYS */;
UNLOCK TABLES;
