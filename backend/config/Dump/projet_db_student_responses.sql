...
CREATE TABLE `student_responses` (
  ...
  CONSTRAINT `student_responses_ibfk_1` FOREIGN KEY (`Id_etu`) REFERENCES `inf_etu` (`Id_etu`),
  CONSTRAINT `student_responses_ibfk_2` FOREIGN KEY (`Id_exam`) REFERENCES `exams` (`Id_exam`),
  CONSTRAINT `student_responses_ibfk_3` FOREIGN KEY (`Id_question`) REFERENCES `questions` (`Id_question`),
  CONSTRAINT `student_responses_chk_1` CHECK ((`Score` >= 0))
